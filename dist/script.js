...
class Application extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      React.createElement("div", { className: size1 },

      React.createElement(Toolbar, { name: " Editor", iconSize: icon1, onClick: this.handleEditorIcons }),

      React.createElement("textarea", { type: "text", id: "editor", value: this.state.inputUser, onChange: this.handleChange })),



      React.createElement("div", { className: size2 },

      React.createElement(Toolbar, { name: " Preview", iconSize: icon2, onClick: this.handlePreviewIcons }),

      React.createElement(Preview, { markdown: this.state.inputUser })),


      React.createElement("div", { style: { width: 90, margin: "auto", fontSize: 20, color: "black" } }, React.createElement("a", { href: "https://github.com/messaismael", target: "_blank", style: { color: "black" } }, " by Ismael"))));
...
class Toolbar extends React.Component {
  render() {
    ...
    return (
      ...
      React.createElement("i", { className: "fa fa-free-code-camp" }, this.props.name, " "),
      React.createElement("div", { style: { flex: 1 } }, "             "),
      React.createElement("i", { onClick: this.props.onClick, className: this.props.iconSize })));
